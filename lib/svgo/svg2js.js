...
module.exports = function(data, callback) {
    ...
    sax.ondoctype = function(doctype) {
        ...
        //Illustrator files use entities for their namespaces, we need to add the to sax.ENTITIES for it to parse correctly and remove them with the EditorNS plugin

        var entity_internal = /ENTITY\s+([^\s]+)\s+"([^"]+)"/gm;//<!ENTITY name "entity_value">
